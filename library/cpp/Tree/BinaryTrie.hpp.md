...
data:
  ...
  bundledCode: "#line 1 \"library/cpp/Tree/BinaryTrie.hpp\"\n#include <array>\n#include\
    ...
    \ T>\nclass Node {\npublic:\n    T x;                 // \u8449\u306E\u5024\n\
    \    int count;           // \u3053\u306E\u30CE\u30FC\u30C9\u3092\u901A\u308B\u56DE\
    \u6570\n    int count_distinct;  // \u3053\u306E\u30CE\u30FC\u30C9\u3092\u9802\
    \u70B9\u3068\u3059\u308B\u8449\u306E\u500B\u6570(=\u7A2E\u985E\u6570)\n\n    //\
    \ \u5DE6\u306E\u5B50\u3068\u53F3\u306E\u5B50\n    std::array<std::unique_ptr<Node>,\
    \ 2> child = {nullptr, nullptr};\n\n    // \u8449\u306E\u3068\u304D\uFF0C\u5DE6\
    \u306E\u8449\u3068\u53F3\u306E\u8449\u3092\u6307\u3059\uFF08\u5B58\u5728\u3057\
    \u306A\u3044\u5834\u5408\u306F DUMMY\u3092\u6307\u3059\uFF09\n    Node *prev;\n\
    \    Node *next;\n\n    Node *parent;\n\n    // \u5DE6\u306E\u5B50\u3092\u6301\
    \u305F\u306A\u3044\u3068\u304D\u306F\u3001\u3053\u306E node \u3092\u6839\u3068\
  ...
  code: "#include <array>\n#include <cassert>\n#include <limits>\n#include <memory>\n\
    ...
    \u6839\u3068\u3059\u308B\u90E8\u5206\u6728\u306B\u304A\u3051\u308B\u6700\u5927\
    \u306E\u8449\u3092\u6307\u3059\n    // Trie \u304C\u7A7A\u306E\u3068\u304D\u306F\
    \ DUMMY \u3092\u6307\u3059\n    Node *jump;\n\n    Node() : x(0), count(0), count_distinct(0),\
    \ prev(nullptr), next(nullptr), parent(nullptr), jump(nullptr) {}\n\n    Node(const\
    \ T x, int count) : x(x), count(count), count_distinct(0), prev(nullptr), next(nullptr),\
  ...
  verifiedWith:
  - test/cpp/Tree/BinaryTrie13_find_mex.test.cpp
  - test/cpp/Tree/BinaryTrie4_count.test.cpp
  - test/cpp/Tree/BinaryTrie5_count_less_than_x.test.cpp
  - test/cpp/Tree/BinaryTrie10_find_kth_max_element.test.cpp
  ...
  - test/cpp/Tree/BinaryTrie1_exist.test.cpp
  ...
  - test/cpp/Tree/BinaryTrie6_median.test.cpp
documentation_of: library/cpp/Tree/BinaryTrie.hpp
layout: document
redirect_from:
- /library/library/cpp/Tree/BinaryTrie.hpp
- /library/library/cpp/Tree/BinaryTrie.hpp.html

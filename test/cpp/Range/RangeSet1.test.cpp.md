...
data:
  ...
  bundledCode: "#line 1 \"test/cpp/Range/RangeSet1.test.cpp\"\n#define PROBLEM \"\
    https://atcoder.jp/contests/abc256/tasks/abc256_d\"\n\n#line 1 \"library/cpp/Range/RangeSet.hpp\"\
    \n#include <cassert>\n#include <iostream>\n#include <numeric>\n#include <set>\n\
    \n// \u533A\u9593\u3092 set \u3067\u7BA1\u7406\u3059\u308B\ntemplate<class T>\n\
    ...
    \  }\n};\n#line 5 \"test/cpp/Range/RangeSet1.test.cpp\"\n\nusing namespace std;\n\
  ...
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc256/tasks/abc256_d\"\n\n\
    ...
    \    cout << l << \" \" << r << endl;\n    }\n\n    return 0;\n}"
  dependsOn:
  - library/cpp/Range/RangeSet.hpp
  isVerificationFile: true
  path: test/cpp/Range/RangeSet1.test.cpp
  requiredBy: []
  timestamp: '2024-01-28 14:22:06+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/cpp/Range/RangeSet1.test.cpp
layout: document
redirect_from:
- /verify/test/cpp/Range/RangeSet1.test.cpp
- /verify/test/cpp/Range/RangeSet1.test.cpp.html

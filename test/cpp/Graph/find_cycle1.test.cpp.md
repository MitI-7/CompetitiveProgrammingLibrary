...
data:
  ...
  bundledCode: "#line 1 \"test/cpp/Graph/find_cycle1.test.cpp\"\n#define PROBLEM \"\
    https://judge.yosupo.jp/problem/cycle_detection_undirected\"\n\n#include <iostream>\n\
    ...
    template<typename T>\nbool find_cycle_dfs(const int u, const Edge <T> &prev, std::vector<int>\
    \ &state, std::vector <Edge<T>> &edges, const Graph <T> &graph) {\n    state[u]\
    \ = 1;\n    for (const auto e: graph.graph[u]) {\n        if (e.no == prev.no)\
    \ {\n            continue;\n        }\n\n        // \u63A2\u7D22\u6E08\u307F\n\
    \        if (state[e.to] == 2) {\n            break;\n        }\n\n        edges.emplace_back(e);\n\
    \        // find cycle\n        if (state[e.to] == 1 or find_cycle_dfs(e.to, e,\
    \ state, edges, graph)) {\n            return true;\n        }\n        edges.pop_back();\n\
    \    }\n\n    state[u] = 2;\n    return false;\n}\n\n// \u6709\u52B9/\u7121\u5411\
    \u30B0\u30E9\u30D5\u306E\u30B5\u30A4\u30AF\u30EB\u3092\u3072\u3068\u3064\u898B\
    \u3064\u3051\u308B\n// \u5358\u7D14\u30B0\u30E9\u30D5\u3067\u306A\u304F\u3066\u3082\
  ...
  requiredBy: []
  timestamp: '2023-05-15 18:41:28+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/cpp/Graph/find_cycle1.test.cpp
layout: document
redirect_from:
- /verify/test/cpp/Graph/find_cycle1.test.cpp
- /verify/test/cpp/Graph/find_cycle1.test.cpp.html

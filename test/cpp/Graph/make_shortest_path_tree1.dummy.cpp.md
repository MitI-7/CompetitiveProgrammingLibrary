...
data:
  ...
  bundledCode: "#line 1 \"test/cpp/Graph/make_shortest_path_tree1.dummy.cpp\"\n#define\
    ...
    \ int start, Graph<T> &graph) {\n\n    const auto [_, prev] = dijkstra(start,\
    \ graph);\n\n    Graph<T> shortest_path_tree(graph.num_nodes);\n    for (auto\
    \ e: prev) {\n        if (e.no != -1) {\n            shortest_path_tree.add_directed_edge(e.from,\
    \ e.to, e.w, e.no);\n        }\n    }\n\n    return shortest_path_tree;\n}\n#line\
    \ 5 \"test/cpp/Graph/make_shortest_path_tree1.dummy.cpp\"\n\nusing namespace std;\n\
  ...
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc252/tasks/abc252_e\"\n\n\
    #include <iostream>\n#include \"library/cpp/Graph/make_shortest_path_tree.cpp\"\
    \n\nusing namespace std;\n\nint main() {\n    cin.tie(nullptr);\n    ios::sync_with_stdio(false);\n\
    \n    int N, M;\n    cin >> N >> M;\n    Graph<long long> graph(N);\n    for (int\
    \ i = 0; i < M; ++i) {\n        int A, B, C;\n        cin >> A >> B >> C;\n  \
    \      A--;\n        B--;\n        graph.add_undirected_edge(A, B, C, i + 1);\n\
  ...
  requiredBy: []
  timestamp: '2023-06-12 15:34:00+09:00'
  verificationStatus: LIBRARY_NO_TESTS
  verifiedWith: []
documentation_of: test/cpp/Graph/make_shortest_path_tree1.dummy.cpp
layout: document
redirect_from:
- /library/test/cpp/Graph/make_shortest_path_tree1.dummy.cpp
- /library/test/cpp/Graph/make_shortest_path_tree1.dummy.cpp.html

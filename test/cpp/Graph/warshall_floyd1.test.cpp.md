...
data:
  ...
  bundledCode: "#line 1 \"test/cpp/Graph/warshall_floyd1.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=GRL_1_C\"\n\n#include\
    \ <iostream>\n#line 1 \"library/cpp/Graph/warshall_floyd.cpp\"\n#include <limits>\n\
    #include <vector>\n\n/**\n * \u5168\u30CE\u30FC\u30C9\u9593\u306E\u6700\u77ED\u8DDD\
    ...
    \        if (matrix[u][u] < 0) {\n            return {};\n        }\n    }\n\n\
    \    return matrix;\n}\n#line 5 \"test/cpp/Graph/warshall_floyd1.test.cpp\"\n\n\
  ...
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=GRL_1_C\"\
    \n\n#include <iostream>\n#include \"library/cpp/Graph/warshall_floyd.cpp\"\n\n\
    using namespace std;\n\nint main() {\n    cin.tie(nullptr);\n    ios::sync_with_stdio(false);\n\
    \n    int V, E;\n    cin >> V >> E;\n\n    const auto inf = std::numeric_limits<long\
    \ long>::max();\n\n    vector<vector<long long>> matrix(V, vector<long long>(V,\
    \ inf));\n    for (int i = 0; i < E; ++i) {\n        int S, T, D;\n        cin\
    ...
    \      }\n    }\n\n    return 0;\n}"
  dependsOn:
  - library/cpp/Graph/warshall_floyd.cpp
  isVerificationFile: true
  path: test/cpp/Graph/warshall_floyd1.test.cpp
  requiredBy: []
  timestamp: '2023-05-15 19:58:34+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/cpp/Graph/warshall_floyd1.test.cpp
layout: document
redirect_from:
- /verify/test/cpp/Graph/warshall_floyd1.test.cpp
- /verify/test/cpp/Graph/warshall_floyd1.test.cpp.html

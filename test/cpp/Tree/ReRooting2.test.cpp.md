...
data:
  ...
  bundledCode: "#line 1 \"test/cpp/Tree/ReRooting2.test.cpp\"\n#define PROBLEM \"\
    ...
    \ unit> rr(N);\n */\n#line 4 \"test/cpp/Tree/ReRooting2.test.cpp\"\n#include <iostream>\n\
    \nusing namespace std;\n\n\nint M;\n\ntemplate<typename T>\nT merge(const T accum,\
    \ const T t) {\n    return (accum * t) % M;\n}\n\ntemplate<typename T>\nT add_node(const\
    \ T accum, const int u) {\n    return accum + 1;\n}\n\ntemplate<typename T, typename\
    \ W>\nT add_edge(const T d, Edge<W> e) {\n    return d;\n}\n\ntemplate<typename\
    \ T>\nT unit() {\n    return 1;\n}\n\nusing namespace std;\n\n\nint main() {\n\
    \    cin.tie(nullptr);\n    ios::sync_with_stdio(false);\n\n    int N;\n    cin\
    \ >> N >> M;\n\n    ReRooting<long long, int, merge, add_node, add_edge, unit>\
    \ rr(N);\n    for (int i = 0; i < N - 1; ++i) {\n        int U, V;\n        cin\
  ...
  code: "#define PROBLEM \"https://atcoder.jp/contests/dp/tasks/dp_v\"\n\n#include\
    ...
    \n\nint M;\n\ntemplate<typename T>\nT merge(const T accum, const T t) {\n    return\
    \ (accum * t) % M;\n}\n\ntemplate<typename T>\nT add_node(const T accum, const\
    \ int u) {\n    return accum + 1;\n}\n\ntemplate<typename T, typename W>\nT add_edge(const\
    \ T d, Edge<W> e) {\n    return d;\n}\n\ntemplate<typename T>\nT unit() {\n  \
    \  return 1;\n}\n\nusing namespace std;\n\n\nint main() {\n    cin.tie(nullptr);\n\
    \    ios::sync_with_stdio(false);\n\n    int N;\n    cin >> N >> M;\n\n    ReRooting<long\
    \ long, int, merge, add_node, add_edge, unit> rr(N);\n    for (int i = 0; i <\
    \ N - 1; ++i) {\n        int U, V;\n        cin >> U >> V;\n        U--;\n   \
    \     V--;\n        rr.add_undirected_edge(U, V);\n    }\n    rr.build();\n\n\
  ...
  requiredBy: []
  timestamp: '2024-02-05 18:57:29+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/cpp/Tree/ReRooting2.test.cpp
layout: document
redirect_from:
- /verify/test/cpp/Tree/ReRooting2.test.cpp
- /verify/test/cpp/Tree/ReRooting2.test.cpp.html

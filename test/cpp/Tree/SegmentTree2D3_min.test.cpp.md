...
data:
  ...
  bundledCode: "#line 1 \"test/cpp/Tree/SegmentTree2D3_min.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=1068\"\n\n#line\
    \ 1 \"library/cpp/Tree/SegmentTree2D.hpp\"\n#include <cassert>\n#include <numeric>\n\
    #include <vector>\n\ntemplate<class T, T (*op)(T, T), T (*unit)()>\nclass SegmentTree2D\
    \ {\nprivate:\n    int H;\n    int W;\n    int H2;\n    int W2;\n    std::vector<std::vector<T>>\
    \ data;\n\npublic:\n    SegmentTree2D(const std::vector<std::vector<T>> &grid)\
    \ : H(grid.size()), W(grid[0].size()), H2(1), W2(1) {\n        while (this->H2\
    \ < this->H) {\n            this->H2 <<= 1;\n        }\n        while (this->W2\
  ...
  requiredBy: []
  timestamp: '2024-02-29 16:40:34+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/cpp/Tree/SegmentTree2D3_min.test.cpp
layout: document
redirect_from:
- /verify/test/cpp/Tree/SegmentTree2D3_min.test.cpp
- /verify/test/cpp/Tree/SegmentTree2D3_min.test.cpp.html

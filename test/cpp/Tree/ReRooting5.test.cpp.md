...
data:
  ...
  bundledCode: "#line 1 \"test/cpp/Tree/ReRooting5.test.cpp\"\n#define PROBLEM \"\
    ...
    \ unit> rr(N);\n */\n#line 4 \"test/cpp/Tree/ReRooting5.test.cpp\"\n#include <iostream>\n\
    ...
    \ add_edge(const T t, Edge<W> e) {\n    return t;\n}\n\ntemplate<typename T>\n\
    T unit() {\n    return {0, 0};\n}\n\nint main() {\n    cin.tie(nullptr);\n   \
    \ ios::sync_with_stdio(false);\n\n    int N;\n    cin >> N;\n\n    ReRooting<pair<int,\
    \ int>, int, merge, add_node, add_edge, unit> rr(N);\n    for (int i = 0; i <\
    \ N - 1; ++i) {\n        int U, V;\n        cin >> U >> V;\n        U--;\n   \
  ...
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc223/tasks/abc223_g\"\n\n\
    ...
    \ std;\n\n\ntemplate<typename T>\nT merge(const T accum, const T t) {\n    return\
    \ {accum.first + t.first, accum.second + t.second};\n}\n\ntemplate<typename T>\n\
    T add_node(const T accum, const int u) {\n    // \u30DE\u30C3\u30C1\u30F3\u30B0\
    \u306B\u4F7F\u3063\u3066\u3044\u306A\u3044\u5B50\u304C\u3044\u308B\n    if (accum.second\
    \ >= 1) {\n        return {accum.first + 1, 0};\n    }\n    return {accum.first,\
    ...
    \    int N;\n    cin >> N;\n\n    ReRooting<pair<int, int>, int, merge, add_node,\
    \ add_edge, unit> rr(N);\n    for (int i = 0; i < N - 1; ++i) {\n        int U,\
  ...
  requiredBy: []
  timestamp: '2024-02-20 18:37:25+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/cpp/Tree/ReRooting5.test.cpp
layout: document
redirect_from:
- /verify/test/cpp/Tree/ReRooting5.test.cpp
- /verify/test/cpp/Tree/ReRooting5.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/cpp/Tree/WeightedUnionFind1.test.cpp\"\n#define PROBLEM\
    ...
    \    }\n};\n#line 4 \"test/cpp/Tree/WeightedUnionFind1.test.cpp\"\n#include <iostream>\n\
    \nusing namespace std;\n\n\nint main() {\n    cin.tie(nullptr);\n    ios::sync_with_stdio(false);\n\
    \n    int N, Q;\n    cin >> N >> Q;\n\n    WeightedUnionFind<long long> wuf(N);\n\
    \n    vector<int> ans;\n    for (int i = 0; i < Q; ++i) {\n        int A, B, D;\n\
    \        cin >> A >> B >> D;\n        A--;\n        B--;\n\n        if (wuf.unite(A,\
    \ B, -D)) {\n            ans.emplace_back(i + 1);\n        }\n    }\n\n    for\
    \ (int i = 0; i < (int) ans.size(); ++i) {\n        if (i != 0) {\n          \
    \  cout << \" \";\n        }\n        cout << ans[i];\n    }\n    cout << endl;\n\
    \n    return 0;\n}\n"
  ...
  requiredBy: []
  timestamp: '2024-01-27 12:52:29+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/cpp/Tree/WeightedUnionFind1.test.cpp
layout: document
redirect_from:
- /verify/test/cpp/Tree/WeightedUnionFind1.test.cpp
- /verify/test/cpp/Tree/WeightedUnionFind1.test.cpp.html

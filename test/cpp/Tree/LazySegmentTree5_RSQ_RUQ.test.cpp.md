...
data:
  ...
  bundledCode: "#line 1 \"test/cpp/Tree/LazySegmentTree5_RSQ_RUQ.test.cpp\"\n#define\
    \ PROBLEM \"https://atcoder.jp/contests/abc237/tasks/abc237_g\"\n\n#line 1 \"\
    library/cpp/Tree/LazySegmentTree.hpp\"\n#include <cassert>\n#include <functional>\n\
    #include <numeric>\n#include <vector>\n\ntemplate<typename T>\nT op(const T left_value,\
    ...
    \ / 3,\n    };\n}\n*/\n#line 4 \"test/cpp/Tree/LazySegmentTree5_RSQ_RUQ.test.cpp\"\
    \n#include <iostream>\n\nusing namespace std;\n\nint main() {\n    cin.tie(nullptr);\n\
    ...
    \ + num_0, L + num_0 + num_1, 1);\n            lst.operation(L + num_0 + num_1,\
    \ L + num_0 + num_1 + num_2, 2);\n        } else {\n            lst.operation(L,\
  ...
  requiredBy: []
  timestamp: '2024-03-09 23:47:14+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/cpp/Tree/LazySegmentTree5_RSQ_RUQ.test.cpp
layout: document
redirect_from:
- /verify/test/cpp/Tree/LazySegmentTree5_RSQ_RUQ.test.cpp
- /verify/test/cpp/Tree/LazySegmentTree5_RSQ_RUQ.test.cpp.html

...
data:
  ...
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc218/tasks/abc218_g\"\n\n\
    ...
    \n#include <iostream>\n\nusing namespace std;\n\nvector<int> A;\n\nint dfs(int\
    \ u, int no, int p, BinaryTrie<unsigned int, 32> &bt, Tree<int> &tree) {\n\n \
  ...
  verifiedWith: []
documentation_of: test/cpp/Tree/BinaryTrie7_median.test.cpp
layout: document
redirect_from:
- /verify/test/cpp/Tree/BinaryTrie7_median.test.cpp
- /verify/test/cpp/Tree/BinaryTrie7_median.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/cpp/Tree/BinaryTrie5_count_less_than_x.test.cpp\"\n\
    ...
    \ & 1u;\n    }\n};\n#line 4 \"test/cpp/Tree/BinaryTrie5_count_less_than_x.test.cpp\"\
    \n#include <iostream>\n\nusing namespace std;\n\nint main() {\n    cin.tie(nullptr);\n\
    ...
    \ ans = bt.find_kth_min_element(num + K);\n            if (ans == bt.NOTFOUND)\
    \ {\n                ans = -1;\n            }\n            cout << ans << endl;\n\
    \        }\n    }\n\n    return 0;\n}\n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc241/tasks/abc241_d\"\n\n\
    ...
    \ >> QUERY >> X;\n        if (QUERY == 1) {\n            bt.insert(X);\n     \
    \   } else if (QUERY == 2) {\n            cin >> K;\n            K--;\n      \
    \      const auto num = bt.count_less_than(X + 1);\n            auto ans = bt.find_kth_min_element(num\
    \ - K - 1);\n            if (ans == bt.NOTFOUND) {\n                ans = -1;\n\
    \            }\n            cout << ans << endl;\n        } else {\n         \
    \   cin >> K;\n            K--;\n            const auto num = bt.count_less_than(X);\n\
  ...
  requiredBy: []
  timestamp: '2024-02-19 15:41:25+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/cpp/Tree/BinaryTrie5_count_less_than_x.test.cpp
layout: document
redirect_from:
- /verify/test/cpp/Tree/BinaryTrie5_count_less_than_x.test.cpp
- /verify/test/cpp/Tree/BinaryTrie5_count_less_than_x.test.cpp.html

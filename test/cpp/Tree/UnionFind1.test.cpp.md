...
data:
  ...
  bundledCode: "#line 1 \"test/cpp/Tree/UnionFind1.test.cpp\"\n#define PROBLEM \"\
    ...
    \        }\n    }\n};\n#line 4 \"test/cpp/Tree/UnionFind1.test.cpp\"\n#include\
    \ <iostream>\n\nusing namespace std;\n\nint main() {\n    cin.tie(nullptr);\n\
  ...
  verifiedWith: []
documentation_of: test/cpp/Tree/UnionFind1.test.cpp
layout: document
redirect_from:
- /verify/test/cpp/Tree/UnionFind1.test.cpp
- /verify/test/cpp/Tree/UnionFind1.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/cpp/Tree/ReRooting4.test.cpp\"\n#define PROBLEM \"\
    ...
    \ unit> rr(N);\n */\n#line 4 \"test/cpp/Tree/ReRooting4.test.cpp\"\n#include <iostream>\n\
    \nusing namespace std;\n\nvector<long long> D;\n\n// \u7D2F\u7A4D accum \u3068\
    \ t \u3092\u7D50\u5408\u3059\u308B\u95A2\u6570\n// \uFF08\u5B50\u4F9B\u9054\u306E\
    \u7D50\u5408\u306E\u307F\u8003\u616E\u3057\uFF0C\u89AA\u306B\u7D50\u5408\u3059\
    \u308B\u3068\u304D\u306E\u3053\u3068\u306F\u8003\u3048\u306A\u3044\u3053\u3068\
    ...
    \n    int N;\n    cin >> N;\n\n    ReRooting<long long, long long, merge, add_node,\
    \ add_edge, unit> rr(N);\n    for (int i = 0; i < N - 1; ++i) {\n        int A,\
    \ B;\n        long long C;\n        cin >> A >> B >> C;\n        A--;\n      \
  ...
  requiredBy: []
  timestamp: '2024-02-17 12:53:45+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/cpp/Tree/ReRooting4.test.cpp
layout: document
redirect_from:
- /verify/test/cpp/Tree/ReRooting4.test.cpp
- /verify/test/cpp/Tree/ReRooting4.test.cpp.html

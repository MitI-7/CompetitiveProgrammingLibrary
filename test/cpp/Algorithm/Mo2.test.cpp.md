...
data:
  ...
  bundledCode: "#line 1 \"test/cpp/Algorithm/Mo2.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc293/tasks/abc293_g\"\
    ...
    \u72B6\u614B\u306E\u5909\u5316\u3068\u7B54\u3048\u3092\u8A08\u7B97\ntemplate<class\
    \ T>\nT del(const int idx, T query_ans) {\n    color[A[idx]]--;\n    query_ans\
    \ -= (color[A[idx]] == 0);\n    return query_ans;\n}\n*/\n#line 4 \"test/cpp/Algorithm/Mo2.test.cpp\"\
    ...
    \ {\n        cout << a << endl;\n    }\n\n    return 0;\n}\n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc293/tasks/abc293_g\"\n\n\
...
layout: document
redirect_from:
- /verify/test/cpp/Algorithm/Mo2.test.cpp
- /verify/test/cpp/Algorithm/Mo2.test.cpp.html

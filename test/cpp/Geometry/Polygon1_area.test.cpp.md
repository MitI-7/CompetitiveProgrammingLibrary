...
data:
  ...
  attributes:
    ...
    PROBLEM: https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_3_A&lang=ja
    links:
    - https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_3_A&lang=ja
  bundledCode: "#line 1 \"test/cpp/Geometry/Polygon1_area.test.cpp\"\n#define PROBLEM\
    ...
    \                return false;\n            }\n        }\n\n        return true;\n\
    \    }\n};\n#line 4 \"test/cpp/Geometry/Polygon1_area.test.cpp\"\n#include <iomanip>\n\
    #include <iostream>\n\nusing namespace std;\n\nint main() {\n    cin.tie(nullptr);\n\
    \    ios::sync_with_stdio(false);\n\n    int N;\n    cin >> N;\n    vector <Point<double>>\
    \ points(N);\n    for (int i = 0; i < N; ++i) {\n        double X, Y;\n      \
    \  cin >> X >> Y;\n        points[i] = {X, Y};\n    }\n\n    Polygon<double> polygon(points);\n\
    \    cout << setprecision(1) << fixed << polygon.double_polygon_area() / 2.0 <<\
    \ endl;\n\n    return 0;\n}\n"
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_3_A&lang=ja\"\
  ...
  requiredBy: []
  timestamp: '2024-01-20 16:46:09+09:00'

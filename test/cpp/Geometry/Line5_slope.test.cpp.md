...
data:
  ...
  attributes:
    ...
    PROBLEM: https://atcoder.jp/contests/abc187/tasks/abc187_b
    links:
    - https://atcoder.jp/contests/abc187/tasks/abc187_b
  bundledCode: "#line 1 \"test/cpp/Geometry/Line5_slope.test.cpp\"\n#define PROBLEM\
    ...
    \ != (td < 0)));\n\n        return a and b;\n    }\n    \n    // \u4EA4\u70B9\n\
    };\n#line 4 \"test/cpp/Geometry/Line5_slope.test.cpp\"\n#include <iostream>\n\
    #include <vector>\n\nusing namespace std;\n\nint main() {\n    cin.tie(nullptr);\n\
    ...
    \            if (p.second == 0) {\n                continue;\n            }\n\
    \            if (-1.0 <= (double) p.first / p.second and (double) p.first / p.second\
    \ <= 1.0) {\n                ans++;\n            }\n        }\n    }\n    cout\
    \ << ans << endl;\n\n    return 0;\n}\n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc187/tasks/abc187_b\"\n\n\
    ...
    \        for (int j = i + 1; j < N; ++j) {\n            Line line(points[i], points[j]);\n\
    \            auto p = line.slope();\n            if (p.second == 0) {\n      \
    \          continue;\n            }\n            if (-1.0 <= (double) p.first\
    \ / p.second and (double) p.first / p.second <= 1.0) {\n                ans++;\n\
    \            }\n        }\n    }\n    cout << ans << endl;\n\n    return 0;\n\
    }\n"
  dependsOn:
  ...
  requiredBy: []
  timestamp: '2024-02-10 10:50:15+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/cpp/Geometry/Line5_slope.test.cpp
layout: document
redirect_from:
- /verify/test/cpp/Geometry/Line5_slope.test.cpp
- /verify/test/cpp/Geometry/Line5_slope.test.cpp.html

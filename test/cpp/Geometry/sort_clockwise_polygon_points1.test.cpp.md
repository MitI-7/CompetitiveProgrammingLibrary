...
data:
  ...
  bundledCode: "#line 1 \"test/cpp/Geometry/sort_clockwise_polygon_points1.test.cpp\"\
    ...
    \ n;\n    FenwickTree<T> ft0, ft1;\n\npublic:\n    explicit FenwickTreeRange(const\
    \ int n) : n(n), ft0(n + 1), ft1(n + 1) {}\n\n    // v[i]\n    // O(log n)\n \
    ...
    \   if (left == right) {\n            return;\n        }\n        assert(0 <=\
    \ left and left < right and right <= this->n);\n        this->ft0.add(left, x);\n\
    ...
    \ << std::endl;\n    }\n};\n#line 6 \"test/cpp/Geometry/sort_clockwise_polygon_points1.test.cpp\"\

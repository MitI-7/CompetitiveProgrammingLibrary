...
data:
  ...
  attributes:
    ...
    PROBLEM: https://atcoder.jp/contests/abc248/tasks/abc248_e
    links:
    - https://atcoder.jp/contests/abc248/tasks/abc248_e
  bundledCode: "#line 1 \"test/cpp/Geometry/Line6_online.test.cpp\"\n#define PROBLEM\
    ...
    \ != (td < 0)));\n\n        return a and b;\n    }\n};\n#line 4 \"test/cpp/Geometry/Line6_online.test.cpp\"\
    \n#include <iostream>\n#include <set>\n#include <vector>\n\nusing namespace std;\n\
    \nint main() {\n    cin.tie(nullptr);\n    ios::sync_with_stdio(false);\n\n  \
    \  int N, K;\n    cin >> N >> K;\n    vector<Point<long long>> A(N);\n    for\
    \ (int i = 0; i < N; ++i) {\n        long long X, Y;\n        cin >> X >> Y;\n\
    \        A[i] = Point(X, Y);\n    }\n\n    if (K == 1) {\n        cout << \"Infinity\"\
    \ << endl;\n        return 0;\n    }\n\n    set<pair<pair<long long, long long>,\
    \ pair<long long, long long>>> ans;\n    for (int i = 0; i < N; ++i) {\n     \
    \   for (int j = i + 1; j < N; ++j) {\n            Line<long long> line(A[i],\
    \ A[j]);\n\n            int count = 0;\n            for (int k = 0; k < N; ++k)\
  ...
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc248/tasks/abc248_e\"\n\n\
    ...
    \       cin >> X >> Y;\n        A[i] = Point(X, Y);\n    }\n\n    if (K == 1)\
    \ {\n        cout << \"Infinity\" << endl;\n        return 0;\n    }\n\n    set<pair<pair<long\
    \ long, long long>, pair<long long, long long>>> ans;\n    for (int i = 0; i <\
    \ N; ++i) {\n        for (int j = i + 1; j < N; ++j) {\n            Line<long\
    \ long> line(A[i], A[j]);\n\n            int count = 0;\n            for (int\
    \ k = 0; k < N; ++k) {\n                count += line.on_line(A[k]);\n       \
    \     }\n\n            if (count >= K) {\n                auto p1 = line.slope();\n\
  ...
  requiredBy: []
  timestamp: '2024-02-10 10:59:57+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/cpp/Geometry/Line6_online.test.cpp
layout: document
redirect_from:
- /verify/test/cpp/Geometry/Line6_online.test.cpp
- /verify/test/cpp/Geometry/Line6_online.test.cpp.html

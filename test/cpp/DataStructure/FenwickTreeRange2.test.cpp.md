...
data:
  ...
  bundledCode: "#line 1 \"test/cpp/DataStructure/FenwickTreeRange2.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_G&lang=ja\"\
    ...
    \    }\n};\n#line 4 \"test/cpp/DataStructure/FenwickTreeRange2.test.cpp\"\n#include\
    \ <iostream>\n\nusing namespace std;\n\nint main() {\n    cin.tie(nullptr);\n\
  ...
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_G&lang=ja\"\
    \n\n#include \"library/cpp/DataStructure/FenwickTreeRange.hpp\"\n#include <iostream>\n\
    \nusing namespace std;\n\nint main() {\n    cin.tie(nullptr);\n    ios::sync_with_stdio(false);\n\
    \n    int N, Q;\n    cin >> N >> Q;\n\n    FenwickTreeRange<long long> ftr(N);\n\
    \    for (int _ = 0; _ < Q; ++_) {\n        int QUERY, S, T, X;\n        cin >>\
    \ QUERY >> S >> T;\n        S--;\n        T--;\n        if (QUERY == 0) {\n  \
  ...
  requiredBy: []
  timestamp: '2023-06-03 11:57:52+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/cpp/DataStructure/FenwickTreeRange2.test.cpp
layout: document
redirect_from:
- /verify/test/cpp/DataStructure/FenwickTreeRange2.test.cpp
- /verify/test/cpp/DataStructure/FenwickTreeRange2.test.cpp.html
